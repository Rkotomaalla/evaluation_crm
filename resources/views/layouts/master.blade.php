...
<!-- 1️⃣ Icônes et polices externes -->
<link href="{{ URL::asset('css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
<link href="https://unpkg.com/ionicons@4.5.5/dist/css/ionicons.min.css" rel="stylesheet">

<!-- 2️⃣ Styles liés à Bootstrap et frameworks CSS -->
<link href="{{ URL::asset('css/jasny-bootstrap.css') }}" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="{{ asset(elixir('css/bootstrap-select.min.css')) }}">

<!-- 3️⃣ Styles pour plugins spécifiques -->
...
<!-- Charger jQuery UI et ses dépendances -->
<script type="text/javascript" src="{{ URL::asset('js/jquery-ui-sortable.min.js') }}"></script>

<!-- Charger les plugins qui nécessitent jQuery -->
...
<!-- Charger Bootstrap et ses plugins -->
<script type="text/javascript" src="{{ URL::asset('js/jasny-bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/bootstrap-tour-standalone.min.js') }}"></script>

<!-- Charger Summernote et Dropzone après jQuery et Bootstrap -->
<script type="text/javascript" src="{{ URL::asset('js/dropzone.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/summernote.min.js') }}"></script>

<!-- Charger les autres plugins -->
<script type="text/javascript" src="{{ URL::asset('js/picker.js') }}"></script>
<script>
    if (typeof $.fn.collapse === 'undefined') {
        console.log('⚠️ Bootstrap collapse() n\'est pas chargé correctement.');
    } else {
        console.log('✅ Bootstrap collapse() fonctionne.');
    }
    </script>
@if(App::getLocale() == "dk")
<script>
